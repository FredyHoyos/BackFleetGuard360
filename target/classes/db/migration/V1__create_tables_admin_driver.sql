...
create table driver (id bigint not null, address varchar(255) not null, birth_date timestamp(6) not null, document_number varchar(255) not null, email varchar(255) not null, name varchar(255) not null, password varchar(255) not null, phone_number varchar(255) not null, photo varchar(255), rol varchar(255) not null, sex smallint check (sex between 0 and 2), username varchar(255) not null, fk_document_type integer not null, primary key (id));
